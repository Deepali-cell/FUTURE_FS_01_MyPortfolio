export const projects = [
  ...
  },
  {
    title: "QuizMaker",
    description:
      "QuizMaker is a web app where users can take quizzes and creators can manage quizzes (CRUD). Real-time scoring tracks user performance. Built with MERN stack.",
    github: "https://github.com/Deepali-cell/CODSOFT--QUIZMAKER",
    demo: "https://codsoft-quizmaker-frontend.onrender.com",
  ...
  //   title: "ZomatoReel",
  //   description:
  //     "A food delivery web app where creators can upload dishes and short food reels. Users can explore both reels and food items, and place orders seamlessly. Built with MERN stack",
  //   github: "https://github.com/Deepali-cell/zomato2.0",
  //   demo: "https://zomato2-0-frontend.onrender.com/",
  //   image: "/projects/zomatoreel.jpg",
  // },
];
